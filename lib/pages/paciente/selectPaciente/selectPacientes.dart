    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.of(context)
            .pushReplacement( // Usamos pushReplacement para que no se quede en el stack
            ...
            children: [
              ...
              Expanded(
                child: StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance.collection('pacientes')
                      .snapshots(),
                  builder: (context, snapshot) {
                    ...
                    return ListView.builder(
                      shrinkWrap: true,
                      // Para que el ListView ocupe solo el espacio necesario
                      itemCount: pacientes.length,
                      itemBuilder: (context, index) {
                        final paciente = pacientes[index].data() as Map<
                            String,
                            dynamic>;
                        final pacienteId = pacientes[index].id;
                        final pacienteNombre = paciente['nombre'] ??
                            'Sin Nombre';
                        ...
                        return ListTile(
                          ...
                          onTap: () {
                            ...
                            widget.onPacienteSeleccionado(
                                pacienteId, pacienteNombre, pacienteApellido);
                            setState(() {
              ...
              // El botón cancelar se mantiene fijo en la parte inferior
              Row(
                ...
                children: [
                  TextButton(
                    onPressed: () {
                      ...
                      Navigator.of(context).pop(); // Cerrar el modal
                      Navigator.of(context)
                          .pushReplacement( // Usamos pushReplacement para evitar el fondo negro
                        MaterialPageRoute(
